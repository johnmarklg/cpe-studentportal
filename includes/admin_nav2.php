...
<!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin/index.php"><img style="max-width:100%;max-height:100%;" src="/assets/images/cpe-portal-white.png"/></a>
            </div>
			<ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    <a href="/admin/index.php" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" id="tabs">
                <ul class="nav navbar-nav side-nav">
                    <li>
						...
						?>
                            <!--<li>
								<a href="/admin/showhide.php"><i class="fa fa-fw fa-eye"></i> Display Announcements</a>
							</li>-->
							<li>
								<a href="/admin/gallery.php"><i class="fa fa-fw fa-photo"></i> Gallery</a>
							</li>
							<li>
								<a href="/admin/videos.php"><i class="fa fa-fw fa-film"></i> Videos</a>
							</li>
							<li>
					...
					<li>
                        ...
                        <?php
						if((basename($_SERVER['SCRIPT_NAME'])=='profilereq.php')||(basename($_SERVER['SCRIPT_NAME'])=='activity.php')||(basename($_SERVER['SCRIPT_NAME'])=='students.php')||(basename($_SERVER['SCRIPT_NAME'])=='handouts.php')||(basename($_SERVER['SCRIPT_NAME'])=='records.php')||(basename($_SERVER['SCRIPT_NAME'])=='timetables.php')) {
						...
						?>
							...
							<li>
								<a href="/admin/students.php"><i class="fa fa-fw fa-graduation-cap"></i> Student Records</a>
							</li>
							<li>
								<a href="handouts.php"><i class="fa fa-fw fa-file"></i> Handouts</a>
							</li>
							<li>
								<a href="/admin/timetables.php"><i class="fa fa-fw fa-book"></i> Class Scheduler</a>
							</li>
                        </ul>
                    </li>
                    <?php
