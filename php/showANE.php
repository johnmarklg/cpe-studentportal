										...
										<div class="col-lg-6">
											<div class="panel panel-primary">
												...
												<div class="panel-body tab-content" style="overflow: auto; max-height:635px;">';
													...
													echo '<hr/>' . $row['post'];
													echo '</div></div><div class="panel-footer"><a href="'. $_SERVER["DOCUMENT_ROOT"] . '/php/showPost.php?postID=' . $row['id'] . '&studnum=' . $studnum . '"><i class="fa fa-fw fa-comment"></i> '. $commentcount . ' comments</a></div></div>';
													}
