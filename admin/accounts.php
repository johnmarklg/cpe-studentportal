        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="accounts.php"><i class="fa fa-fw fa-credit-card"></i> Financial Management</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
					   <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-credit-card"></i> Financial Management
                            </li>
                        </ol>
						...
						<div class="panel panel-info">
							<div class="panel-heading" style="text-align: center;" id="exTab2">	
								<ul class="nav nav-pills nav-justified">
									<li class="active">
									<a  href="#1" data-toggle="tab"><i class="fa fa-fw fa-plus"></i> Add New Payments</a>
									</li>
