											...
											<div class="panel-body">
												<div class="panel panel-info">
													...
													<div class="panel-body">
														...
														<video height="400" preload="none" style="width: 100%;" preload="none" controls no-cache>
														  <source src="/uploads/video/movie.mp4?t=<?php echo date('parameters');?>" type="video/mp4">
														  <source src="/uploads/video/movie.ogg?t=<?php echo date('parameters');?>" type="video/ogg">
