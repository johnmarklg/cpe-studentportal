...
?>
  <body>
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        ...
        <div class="mdl-layout__header-row">
          ...
          <div class="android-navigation-container">
            <nav class="android-navigation mdl-navigation">
              ...
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Add Student</a>
            </nav>
          </div>
      ...
      <div class="android-drawer mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
          ...
          <a class="mdl-navigation__link" href="">Add Student</a>
    ...
    <form> <!--action="ajax/updateRecords.php" method="post"-->
		<button onclick="return confirm('Are you sure?');" type="button" id="view-source" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast">Save Changes</button>
    </form>	
<?php
    get_footer();
?>